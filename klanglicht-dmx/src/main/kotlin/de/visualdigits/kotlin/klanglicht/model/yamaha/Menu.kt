...
class Menu : AbstractMenuProvider() {
    ...
    val put1: List<de.visualdigits.kotlin.klanglicht.model.yamaha.Put1> = listOf()
    ...
    val get: de.visualdigits.kotlin.klanglicht.model.yamaha.Get? = null

    @JacksonXmlProperty(localName = "Cmd_List")
    val commandList: de.visualdigits.kotlin.klanglicht.model.yamaha.CmdList? = null

    @JacksonXmlProperty(localName = "FKey")
    @JacksonXmlElementWrapper(localName = "FKey", useWrapping = false)
    val fkey: List<de.visualdigits.kotlin.klanglicht.model.yamaha.FKey> = listOf()
